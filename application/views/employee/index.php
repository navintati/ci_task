			...
			<div class="modal-content">
				<form action="<?= base_url(); ?>main/putData" method="post" enctype="multipart/form-data"> 
					...
					<div class="modal-body">					
						...
						<div class="form-group">
							<label>Address</label>
							<textarea class="form-control" name="homeadd" ></textarea>
						</div>
						<div class="form-group">
							<label>Phone</label>
						...
						<div class="form-group">
							...
							<input type="checkbox" value="Football" name="checks[]" >&nbsp;&nbsp;Football &nbsp; &nbsp; 
							<input type="checkbox" value="Cricket" name="checks[]" >&nbsp;&nbsp;Cricket &nbsp; &nbsp; 
							<input type="checkbox" value="Surffing" name="checks[]" >&nbsp;&nbsp;Surffing &nbsp; &nbsp; 
							<input type="checkbox" value="Reading" name="checks[]" >&nbsp;&nbsp;Reading &nbsp;
						</div>
						 <div class="form-group">
